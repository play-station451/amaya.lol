...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const bioMessages = [
    "Betray yourself if you must, hate yourself if you will. But never betray or hate another. Your soul can endure what theirs cannot.",
  ];
  let bioText = '';
  let bioIndex = 0;
  ...
  const DISCORD_USER_ID = "1259553077757874266";
